...
const badgeColors: Record<string, string> = {
  ...
  "CRM": "bg-[hsl(210,70%,50%)]/15 text-[hsl(210,70%,50%)] border-[hsl(210,70%,50%)]/30",
  "GoHighLevel": "bg-[hsl(36,90%,50%)]/15 text-[hsl(36,90%,50%)] border-[hsl(36,90%,50%)]/30",
