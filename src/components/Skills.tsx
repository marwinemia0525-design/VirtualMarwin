          ...
          <div className="flex flex-wrap justify-center gap-3">
            {skillsList.map((skill, index) => (
              <motion.span
                ...
                className="px-4 py-2 bg-card/60 backdrop-blur-sm rounded-full text-sm font-medium text-foreground border border-border/50 hover:border-accent/50 hover:bg-accent/5 hover:text-accent transition-all duration-400 ease-out cursor-default hover:scale-105 hover:-translate-y-1 hover:shadow-[0_10px_30px_hsl(var(--accent)/0.15)]"
              >
                {skill}
              </motion.span>
            ))}
            ...
            >
              ...
              <div className="flex flex-wrap gap-3 relative z-10">
                {category.tools.map((tool, toolIndex) => (
                  <motion.div
                    key={tool.name}
                    className="flex items-center gap-2 px-3 py-2 bg-secondary/50 backdrop-blur-sm rounded-lg border border-border/30 hover:border-accent/50 hover:bg-accent/5 transition-all duration-400 ease-out group/tool hover:scale-105 hover:translate-x-1"
                  ...
                  >
                    <ToolIcon tool={tool} />
                    <span className="text-xs font-medium text-muted-foreground group-hover/tool:text-foreground transition-colors duration-300">
                      {tool.name}
                    </span>
                  </motion.div>
                ))}
