      ...
      <nav className="container-narrow mx-auto px-6 md:px-12">
        <div className="flex items-center justify-between h-16 md:h-18">
          <a href="#" className="flex items-center gap-2 group">
            <div className="relative flex items-center justify-center w-9 h-9 rounded-xl bg-gradient-to-br from-[hsl(199,89%,60%)] to-[hsl(263,70%,58%)] shadow-[0_0_16px_hsl(199_89%_60%/0.3)] group-hover:shadow-[0_0_24px_hsl(199_89%_60%/0.5)] transition-shadow duration-300">
