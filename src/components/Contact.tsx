          ...
          >
            ...
            <div className="space-y-4">
              <a
                ...
                className="flex items-center gap-4 p-4 rounded-xl bg-card/60 backdrop-blur-sm border border-border/50 hover:border-accent/50 transition-all duration-400 ease-out group hover:-translate-y-1"
              >
                <div className="w-12 h-12 rounded-xl bg-accent/10 border border-accent/20 flex items-center justify-center shrink-0 group-hover:bg-accent/20 transition-all duration-400 ease-out group-hover:scale-110">
                  <Mail className="w-5 h-5 text-accent" />
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">Email</p>
                  <p className="font-medium group-hover:text-accent transition-colors duration-300">marwinemia0525@gmail.com</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-medium group-hover:text-accent transition-colors duration-300">+63 763 147 667</p>
                </div>
              </a>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-card/60 backdrop-blur-sm border border-border/50 hover:border-accent/50 hover:text-accent transition-all duration-400 ease-out text-sm hover:scale-105"
              >
                <Linkedin size={18} />
                LinkedIn
              </a>
