...
const UpworkCTA = () => {
  return (
    <section className="section-padding relative overflow-hidden section-glow">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] sm:w-[600px] h-[400px] sm:h-[600px] rounded-full blur-[200px]" style={{ background: "hsl(130 60% 40% / 0.06)" }} />
      ...
      <div className="container-narrow relative z-10 px-4 sm:px-6">
        ...
        >
          <span className="text-xs font-semibold uppercase tracking-[0.2em] mb-3 sm:mb-4 block" style={{ color: "#14A800" }}>
            Upwork
          </span>
          <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-3 sm:mb-4">
            Work With Me on Upwork
          </h2>
          <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto mb-6 sm:mb-8 leading-relaxed px-2">
          ...
          <motion.a
            ...
            whileHover={{ y: -3 }}
            className="inline-flex items-center gap-2 sm:gap-2.5 px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-white transition-all duration-300 text-sm"
            style={{
