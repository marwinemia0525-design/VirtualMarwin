...
const FloatingROI = () => {
  ...
  return (
    <a
      href="/roi"
      className="hidden md:inline-flex fixed bottom-16 left-4 md:bottom-20 md:left-6 z-[60] items-center gap-2 px-4 py-2.5 rounded-full bg-card/95 backdrop-blur border border-border shadow-lg hover:shadow-xl text-foreground hover:text-accent transition-all duration-300 hover:-translate-y-0.5 group cursor-pointer"
